...
A comprehensive web-based hospital management system built with React.js, Node.js, and MongoDB.
</div>
...
**UI** 👉 [LINK](https://Hospital Management System-frontend-lovat.vercel.app)

**Admin Dashboard** 👉 [LINK](https://Hospital Management System-admin-beta.vercel.app)
</div>
...
This project is distributed under [MIT license](https://github.com/elyse502/Hospital Management System/blob/main/LICENSE). Enjoy! 🎉
